...
public class helper {
    ...
    public Location[] combineArrays(UnitController uc, Location[] array1, Location[] array2, Location[] array3, Location[] array4) {
        // Calculate total length
        int totalLength = array1.length + array2.length + array3.length + array4.length;

        uc.println("here in helper 1");
