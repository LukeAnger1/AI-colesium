...
public class map {
    ...
    public void record(UnitController uc) {
        ...
        // IMPORTANT NOTE: This is only a termporary check for obstacles
        obstacles = helper.combineArrays(myAstronautLocs, oponnentAstronautLocs, domes, terraforms, water, myStructureLocs, opponentStructureLocs);
